...
//         // Fetch Steam Iron service (assuming ID 1 based on fallback data)
...
//   if (loading) return <p className="text-center py-8 text-xl">Loading Steam Iron service...</p>;

//   return (
//     <div className="steam-iron-page max-w-7xl mx-auto px-4 py-8">
...
//         <div>
//           <h1 className="text-3xl md:text-4xl font-bold text-white">Steam Iron Service</h1>
//           <p className="text-blue-100 mt-2">Professional steaming and ironing for crisp, wrinkle-free clothes</p>
//         </div>
//         <button 
//           onClick={goBack}
