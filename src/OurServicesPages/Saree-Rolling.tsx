...
const SareeRolling: React.FC = () => {
  ...
  // Fetch Saree Rolling service details
  useEffect(() => {
    const fetchSareeRollingDetails = async () => {
      try {
        const tempToken = await generateToken({
        ...
        if (response.ok && data.ok) {
          ...
          setError(data.message || "Failed to fetch Saree Rolling service details");
        }
      } catch (err) {
        console.error("Fetch error:", err);
        setError("Network error while fetching Saree Rolling service details");
      } finally {
        setLoading(false);
      }
    };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 to-purple-100">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 font-medium">Loading Saree Rolling service...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-r from-indigo-600 via-purple-700 to-pink-800">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
            <div className="text-white space-y-6">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-orange-300 font-medium text-lg">Premium Saree Rolling</span>
              </div>
              
              <div>
                <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-4">
                  Elegant
                  <span className="text-orange-400"> Saree Rolling</span>
                </h1>
                <p className="text-xl text-indigo-100 leading-relaxed max-w-2xl">
                  Professional saree rolling service for safe storage and preservation. Expert care for your precious sarees.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 pt-4">
                <div className="text-center">
                  ...
                  <div className="text-indigo-200 text-sm">Storage</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-orange-400">Expert</div>
                  <div className="text-indigo-200 text-sm">Rolling</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-orange-400">Premium</div>
                  <div className="text-indigo-200 text-sm">Care</div>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Safe Storage</h3>
            <p className="text-gray-600">Proper rolling techniques to prevent damage and creases</p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Layer Protection</h3>
            <p className="text-gray-600">Special materials to protect sarees during storage</p>
          </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 mb-8 border border-gray-100">
          <div className="flex items-center mb-8">
            ...
            <div>
              ...
              <p className="text-gray-600">Choose from our saree rolling categories</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 mb-8 border border-gray-100">
          <div className="flex items-center mb-8">
            ...
            <div>
              ...
              <p className="text-gray-600">Select items for premium saree rolling service</p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-3xl shadow-2xl p-8 text-white">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-indigo-100">Ready for premium saree rolling service</p>
              </div>
            </div>
              ...
              {selectedProducts.map((product) => (
                <div key={`selected-${product.id}`} className="flex justify-between items-center bg-white/10 rounded-xl p-4">
                  <div>
                    ...
                    <p className="text-indigo-100">₹{product.sale}</p>
                  </div>
                  <button
                    onClick={() => handleProductToggle(product)}
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <div className="text-center md:text-left">
                ...
                <div className="text-indigo-100">Total Amount</div>
              </div>
              
              <button
                onClick={handleAddToCart}
                className="bg-white text-indigo-600 px-8 py-4 rounded-2xl font-bold text-lg hover:bg-gray-100 transition-colors shadow-lg flex items-center space-x-2"
              >
