...
//   useEffect(() => {
//     const fetchWashFoldDetails = async () => {
//       try {
...
//         const response = await fetch("https://api-dev.ironbhai.com/v1/app/services/6", {
//           method: "GET",
//           headers: {
...
//         } else {
//           setError(data.message || "Failed to fetch Wash & Fold service details");
//         }
//       } catch (err) {
//         console.error("Fetch error:", err);
//         setError("Network error while fetching Wash & Fold service details");
//       } finally {
//         setLoading(false);
//       }
//     };

//     fetchWashFoldDetails();
//   }, []);
...
//   if (loading) return <p className="text-center py-8 text-xl">Loading Wash & Fold service...</p>;
...
//         <div>
//           <h1 className="text-3xl md:text-4xl font-bold text-white">Wash & Fold Service</h1>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-emerald-100">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 font-medium">Loading Wash & Fold service...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
            <div className="text-white space-y-6">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-orange-300 font-medium text-lg">Convenient Wash & Fold</span>
              </div>
              
              <div>
                <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-4">
                  Clean & Neat
                  <span className="text-orange-400"> Wash & Fold</span>
                </h1>
                <p className="text-xl text-green-100 leading-relaxed max-w-2xl">
                  Complete washing and folding service for busy lifestyles. Fresh, clean clothes neatly folded and ready to wear.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 pt-4">
                <div className="text-center">
                  ...
                  <div className="text-green-200 text-sm">Clean Wash</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-orange-400">Neat</div>
                  <div className="text-green-200 text-sm">Perfect Fold</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-orange-400">Ready</div>
                  <div className="text-green-200 text-sm">To Wear</div>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
            ...
            <p className="text-gray-600">Full wash and fold service for ultimate convenience</p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Perfect Folding</h3>
            <p className="text-gray-600">Professional folding techniques for neat storage</p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
            ...
            <p className="text-gray-600">Fast and efficient service with timely delivery</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 mb-8 border border-gray-100">
          <div className="flex items-center mb-8">
            ...
            <div>
              ...
              <p className="text-gray-600">Choose from our wash & fold categories</p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {categories.map((category) => (
                ...
                >
                  ...
                  <div className="text-sm opacity-80">Wash & fold</div>
                </button>
              ))}
            </div>
          ) : (
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 mb-8 border border-gray-100">
          <div className="flex items-center mb-8">
            ...
            <div>
              ...
              <p className="text-gray-600">Select items for wash & fold service</p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-3xl shadow-2xl p-8 text-white">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-green-100">Ready for wash & fold service</p>
              </div>
            </div>
