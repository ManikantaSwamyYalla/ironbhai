...
//   // Fetch Wash & Iron service details
//   useEffect(() => {
//     const fetchWashIronDetails = async () => {
//       try {
...
//         // Fetch Wash & Iron service (ID 2 based on fallback data)
//         const response = await fetch("https://api-dev.ironbhai.com/v1/app/services/2", {
//           method: "GET",
//           headers: {
...
//         } else {
//           setError(data.message || "Failed to fetch Wash & Iron service details");
//         }
//       } catch (err) {
//         console.error("Fetch error:", err);
//         setError("Network error while fetching Wash & Iron service details");
//       } finally {
//         setLoading(false);
//       }
//     };

//     fetchWashIronDetails();
//   }, []);
...
//   if (loading) return <p className="text-center py-8 text-xl">Loading Wash & Iron service...</p>;
...
//         <div>
//           <h1 className="text-3xl md:text-4xl font-bold text-white">Wash & Iron Service</h1>
...
//           <p className="text-xl text-gray-600 font-medium">Loading Wash & Iron service...</p>
//         </div>
//       </div>
//     );
//   }
...
//       {/* Hero Section */}
//       <div className="relative overflow-hidden bg-gradient-to-r from-teal-600 via-blue-700 to-indigo-800">
...
//                 </div>
//                 <span className="text-orange-300 font-medium text-lg">Complete Wash & Iron</span>
//               </div>
              
//               <div>
//                 <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-4">
//                   Fresh & Clean
//                   <span className="text-orange-400"> Wash & Iron</span>
//                 </h1>
//                 <p className="text-xl text-teal-100 leading-relaxed max-w-2xl">
//                   Complete washing and ironing service for fresh, clean, and perfectly pressed clothes. Professional care from start to finish.
//                 </p>
//               </div>

//               <div className="grid grid-cols-3 gap-6 pt-4">
//                 <div className="text-center">
//                   <div className="text-2xl font-bold text-orange-400">Deep</div>
//                   <div className="text-teal-200 text-sm">Clean Wash</div>
//                 </div>
//                 <div className="text-center">
//                   <div className="text-2xl font-bold text-orange-400">Perfect</div>
//                   <div className="text-teal-200 text-sm">Press & Iron</div>
//                 </div>
//                 <div className="text-center">
//                   <div className="text-2xl font-bold text-orange-400">Fresh</div>
//                   <div className="text-teal-200 text-sm">Fragrance</div>
//                 </div>
//               </div>
//             </div>
...
//             </div>
//             <h3 className="text-xl font-bold text-gray-900 mb-2">Deep Clean Wash</h3>
//             <p className="text-gray-600">Advanced washing technology for thorough cleaning</p>
//           </div>
...
//             </div>
//             <h3 className="text-xl font-bold text-gray-900 mb-2">Perfect Press</h3>
//             <p className="text-gray-600">Professional ironing for crisp, wrinkle-free finish</p>
//           </div>
...
//               <p className="text-gray-600">Choose from our specialized wash & iron categories</p>
//             </div>
//           </div>
...
//                     selectedCategory === category.id
//                       ? 'bg-gradient-to-r from-teal-500 to-blue-600 text-white shadow-xl' 
//                       : 'bg-gray-50 text-gray-700 hover:bg-gray-100 border-2 border-gray-200 hover:border-teal-300'
//                   }`}
//                   onClick={() => handleCategorySelect(category.id)}
//                 >
//                   <div className="font-bold text-lg mb-2">{category.name}</div>
//                   <div className="text-sm opacity-80">Complete care</div>
//                 </button>
//               ))}
//             </div>
//           ) : (
...
//               <p className="text-gray-600">Select items for complete wash & iron service</p>
//             </div>
//           </div>
...
//                           <span className="text-sm text-gray-600">Complete Service</span>
//                         </div>
//                       </div>
//                       {isSelected && (
...
//                         <span className="text-2xl font-bold text-teal-600">₹{product.sale}</span>
//                       </div>
...
//         {/* Selected Products Summary */}
//         {selectedProducts.length > 0 && (
//           <div className="bg-gradient-to-r from-teal-500 to-blue-600 rounded-3xl shadow-2xl p-8 text-white">
//             <div className="flex items-center mb-6">
...
//                 <p className="text-teal-100">Ready for complete wash & iron service</p>
//               </div>
//             </div>
...
//                     <p className="text-teal-100">₹{product.sale}</p>
//                   </div>
//                   <button
//                     onClick={() => handleProductToggle(product)}
...
//                 </div>
//                 <div className="text-teal-100">Total Amount</div>
//               </div>
              
//               <button
//                 onClick={handleAddToCart}
//                 className="bg-white text-teal-600 px-8 py-4 rounded-2xl font-bold text-lg hover:bg-gray-100 transition-colors shadow-lg flex items-center space-x-2"
//               >
