...
//         // Fetch Dry Cleaning service (ID 3 based on API)
//         const response = await fetch("https://api-dev.ironbhai.com/v1/app/services/3", {
//           method: "GET",
//           headers: {
...
//   if (loading) return <p className="text-center py-8 text-xl">Loading Dry Cleaning service...</p>;
...
//         <div>
//           <h1 className="text-3xl md:text-4xl font-bold text-white">Dry Cleaning Service</h1>
//           <p className="text-blue-100 mt-2">Premium dry cleaning for delicate and special fabrics</p>
//         </div>
//         <button 
//           onClick={goBack}
...
const DryCleaning: React.FC = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 to-indigo-100">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 font-medium">Loading Dry Cleaning service...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-r from-purple-600 via-indigo-700 to-blue-800">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
            <div className="text-white space-y-6">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-orange-300 font-medium text-lg">Premium Dry Cleaning</span>
              </div>
              
              <div>
                <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-4">
                  Luxury
                  <span className="text-orange-400"> Dry Cleaning</span>
                </h1>
                <p className="text-xl text-purple-100 leading-relaxed max-w-2xl">
                  Premium dry cleaning service for delicate fabrics and special garments. Expert care with advanced cleaning technology.
                </p>
              </div>

              <div className="grid grid-cols-3 gap-6 pt-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-orange-400">Gentle</div>
                  <div className="text-purple-200 text-sm">Fabric Care</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-orange-400">Expert</div>
                  <div className="text-purple-200 text-sm">Cleaning</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-orange-400">Premium</div>
                  <div className="text-purple-200 text-sm">Quality</div>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Delicate Care</h3>
            <p className="text-gray-600">Specialized treatment for delicate and luxury fabrics</p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
            ...
            <p className="text-gray-600">Advanced dry cleaning technology for best results</p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
            ...
            <p className="text-gray-600">Careful handling and secure delivery service</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 mb-8 border border-gray-100">
          <div className="flex items-center mb-8">
            ...
            <div>
              ...
              <p className="text-gray-600">Choose from our premium dry cleaning categories</p>
            </div>
          </div>
                ...
                <button
                  ...
                  className={`p-6 rounded-2xl text-center transition-all duration-300 transform hover:scale-105 ${
                    selectedCategory === category.id
                      ...
                      : 'bg-gray-50 text-gray-700 hover:bg-gray-100 border-2 border-gray-200 hover:border-purple-300'
                  }`}
                  onClick={() => handleCategorySelect(category.id)}
                >
                  <div className="font-bold text-lg mb-2">{category.name}</div>
                  <div className="text-sm opacity-80">Premium care</div>
                </button>
              ))}
            </div>
          ) : (
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 mb-8 border border-gray-100">
          <div className="flex items-center mb-8">
            ...
            <div>
              ...
              <p className="text-gray-600">Select items for premium dry cleaning service</p>
            </div>
          </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {filteredProducts.map((product) => {
        ...
        {/* Selected Products Summary */}
        {selectedProducts.length > 0 && (
          <div className="bg-gradient-to-r from-purple-500 to-indigo-600 rounded-3xl shadow-2xl p-8 text-white">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-purple-100">Ready for premium dry cleaning service</p>
              </div>
            </div>
              ...
              {selectedProducts.map((product) => (
                <div key={`selected-${product.id}`} className="flex justify-between items-center bg-white/10 rounded-xl p-4">
                  <div>
                    ...
                    <p className="text-purple-100">₹{product.sale}</p>
                  </div>
                  <button
                    onClick={() => handleProductToggle(product)}
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <button
                onClick={handleAddToCart}
                className="bg-white text-purple-600 px-8 py-4 rounded-2xl font-bold text-lg hover:bg-gray-100 transition-colors shadow-lg flex items-center space-x-2"
              >
